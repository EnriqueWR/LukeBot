...
public class LukeMente {
	...
	*/
	...
	public LukeMente() {
		// O robo ja foi treinado, o primeiro valor de cada array é o bias
		this.neuronios = new ArrayList();
		
		double[] pesos1 = { 0.9479268717287725, 0.18698950933079916, 0.6458655685637756 };
		double[] pesos2 = { -0.3029997137859417, -0.535138705280783, -1.3329081164347085 };
		double[] pesos3 = { 0.8528381908493236, 0.4623438163227147, -84.09683518516837 };
		
		Neuronio n1 = new Neuronio(pesos1);
		Neuronio n2 = new Neuronio(pesos2);
		Neuronio n3 = new Neuronio(pesos3);
	...
	public double activate(double[] parms) {
		...
		double[] input1 = { parms[0], parms[1] };
		double[] input2 = { parms[2], parms[3] };
		double output1 = n1.activate(input1);
		double output2 = n2.activate(input2);
		double[] input3 = { output1, output2 }; 
		double output3 = n3.activate(input3);
		return output3;
	}
	...
	public void train(double[] parms, double resp) {
		...
		double[] valoresPeso1 = { pesoAux1, pesoAux1 * parms[0], pesoAux1 * parms[1] };
		...
		double[] valoresPeso2 = { pesoAux2, pesoAux2 * parms[2], pesoAux2 * parms[3] };
